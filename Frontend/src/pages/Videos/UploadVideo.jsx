...
const UploadVideo = () => {
    ...
    const onSubmit = async (e) => {
        ...
        if (videoFile.size > MAX_VIDEO_BYTES)
            return setError("Video size should be less than 1GB.");
        if (thumbnailFile.size > MAX_IMAGE_BYTES)
            return setError("Thumbnail size should be less than 8MB.");
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    <button
                        type="submit"
                        disabled={submitting}
                        className="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-white shadow disabled:opacity-60"
                    >
                    ...
                    <button
                        type="button"
                        onClick={() => navigate(-1)}
                        className="inline-flex items-center rounded-md bg-gray-100 px-4 py-2 text-gray-700"
                    >
                        Cancel
                    </button>
                </div>
